...
export class SharedService {
  ...
  //Loại Sản Phẩm
  layDSLoaiSP():Observable<any[]>{
    return this.http.get<any>(this.APIUrl+'/LoaiSP');
  }
  themLoaiSP(val:any){
    return this.http.post(this.APIUrl+'/LoaiSP', val);
  }
  suaLoaiSP(val:any){
    return this.http.put(this.APIUrl+'/LoaiSP', val);
  }
  xoaLoaiSP(val:any){
    return this.http.delete(this.APIUrl+'/LoaiSP/'+val);
  }
}
